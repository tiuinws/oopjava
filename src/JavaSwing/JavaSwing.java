...
class MyFrame 
    ...
    { 
        ...
        c.add(title); 
         ...
         tnim = new JLabel("Loading..."); 
         tnim.setFont(new Font("Arial", Font.PLAIN, 25)); 
         tnim.setSize(150, 20); 
    ...
    { 
	if (e.getSource() == sub) {
	    tname.setText("Alfian Hidayat");
	    tnim.setText("1808096025");
	}
    //     if (e.getSource() == sub) { 
    //         if (term.isSelected()) { 
    //             String data1; 
